    ...
    20: function(t, e, n) {
        ...
        $(document).ready(function() {
            let t = $("input[name=googleInputKeyCode]").val(),
                ...
                n = !1;
            t || (t = "ne-t-i0-und", console.error('Google Input Key Code not defined. So defaulting to Nepali (ne-t-i0-und). Please specify hidden input: <input type="hidden" name="googleInputKeyCode" value="inputKeyCode(ne-t-i0-und)">')), $("#input_tool").on("keydown", function(t) {
                (function(t) {
            ...
            $("#input_tool").on("keyup", function(t) {
                8 == t.which && ($("#input_tool_helper").empty(), n ? $("#input_tool_helper").append("<em>English mode enabled. Press (CTRL + G) to switch back.</em>") : $("#input_tool_helper").append("<em>Suggestion Word Appears Here!</em>"))
                ...
                if (s) {
                    var c = i[s];
                    void 0 === c && (c = s), o(e, c, t, 4).then(function(t) {
                        t.push(c);
                        let e = "";
                        t.forEach(function(t) {
                            e += '<button class="btn">' + t + "</button>"
                        }), $("#input_tool_helper").empty(), $("#input_tool_helper").append(e), $(".btn").on("click", function(t) {
                            let e = $(this).html();
                            i[e] = c;
                ...
                if (32 == l.which || 229 == l.which) {
                    ...
                    o(e, l, t, 4).then(function(t) {
                        ...
                        }), n[n.length - 2] = t[0], n = n.join(" "), i[t[0]] = l, $("#input_tool").val(n)
                    })
    ...
    21: function(t, e, n) {
        ...
        t.exports = function(t, e, n, o) {
            return new Promise(function(i, l) {
                ...
                t.open("GET", u), t.onreadystatechange = function() {
