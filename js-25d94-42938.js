...
jQuery(document).ready(function($) {
    ...
    $toggles.on('tap', function(e) {
        ...
        $wrapper[0].className = $.trim($wrapper[0].className.replace(/\s*off\-canvas\-effect\-\d+\s*/g, ' ')) + ' ' + $btn.data('effect') + ' ' + 'off-canvas-' + direction;
...
(function($) {
    ...
    T3Menu.prototype = {
        ...
        start: function() {
            ...
            $menu.find('input, select, textarea, label').on('click tap', function(e) {
                e.stopPropagation();
            });
            ...
            if (level == 1) {
                ...
                if (this.options.rtl) {
                    ...
                    if (align == 'right') {
                        ...
                        if (align_offset +
                            (align == 'center' ? sub_width / 2 : sub_width) > screen_width) {
                            align_delta = screen_width -
                                align_offset -
                                (align == 'center' ? sub_width / 2 : sub_width);
                        ...
                        if (align_offset -
                            (align == 'center' ? sub_width / 2 : 0) +
                            align_delta < 0) {
                            sub.css('left', (align == 'center' ? (sub_width + width) / 2 : 0) +
                                align_trans -
                                align_offset);
                        }
                    }
